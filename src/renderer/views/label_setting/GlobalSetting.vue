        ...
        <el-form-item label="内容" required>
          <div class="padding_10" style="background-color: #fefefe">
            ...
            <el-form :inline="true" :model="newMarkTypeTagForm">
              ...
              <el-form-item>
                <el-button type="primary" size="small" @click="handleNewMarkTypeTag">点击新增</el-button>
              </el-form-item>
            </el-form>
          </div>
        </el-form-item>
        ...
        <el-form-item label="内容" required>
          <div class="padding_10" style="background-color: #fefefe">
            ...
            <el-form :inline="true" :model="editMarkTypeTagForm">
              ...
              <el-form-item>
                <el-button type="primary" size="small" @click="handleEditMarkTypeTag">点击新增</el-button>
              </el-form-item>
            </el-form>
          </div>
        </el-form-item>

  ...
  <div id="content">
              ...
              <el-form-item label="预览:">
                <span v-for="(data, index) in props.row.datas" :key="index" class="margin_0_10">
                  <el-tooltip effect="dark" :content="data.name" placement="top">
                    <el-tag :color="data.color" effect="dark">{{ getMaxString(data.tag) }}-{{ getMaxString(data.name) }}</el-tag>
                  </el-tooltip>
                </span>
              </el-form-item>
            </el-form>
      ...
      <el-form :model="newMarkTypeForm" label-position="left" label-width="50px">
          <el-form-item label="名称:">
              <div style="margin-left: 20px">
                  <el-input clearable v-model="newMarkTypeForm.name" placeholder="标签组名称"></el-input>
              </div>
          </el-form-item>
                ...
                <el-row :gutter="10">
                    <el-col :span="8" :key="index" v-for="(tag, index) in newMarkTypeForm.datas">
                        <div class="flex_row align_center">
                            <el-tag style="height: 30px" class="flex_1" :color="tag.color" size="medium" effect="dark" closable :disable-transitions="false" @close="handleNewMarkTypeTagClose(tag, index)">
                                {{ getMaxString(tag.tag) }}-{{ getMaxString(tag.name) }}
                            </el-tag>
        ...
        <div class="separate_line margin_bottom_10"/>

        <el-form :inline="true" >
            <el-form-item label="标签名:">
                <el-input style="width: 120px" v-model="inputNewMarkTypeValue" placeholder="B/E..."></el-input>
            </el-form-item>
            <el-form-item label="描述:">
                <el-input style="width: 120px" v-model="inputNewMarkTypeName" placeholder="开始/结束..."></el-input>
            </el-form-item>
            <el-form-item label="选择颜色:">
                <el-color-picker size="medium" v-model="color" show-alpha :predefine="predefineColors"></el-color-picker>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="handleNewMarkTypeTag">新增</el-button>
            </el-form-item>
        </el-form>
    ...
    <el-dialog width="45%" title="修改-实体标注" :visible.sync="needShowEditMarkTypeView" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
        ...
        <el-form :model="newMarkTypeForm" label-position="left" label-width="50px">
            <el-form-item label="名称:">
                <div style="margin-left: 20px">
                    <el-input clearable v-model="editMarkTypeForm.name" placeholder="标签组名称"></el-input>
                </div>
            </el-form-item>
            <el-form-item label="描述:">
                <div style="margin-left: 20px">
        ...
        <el-form>
            <el-form-item label="">
                <el-row :gutter="10">
                    <el-col :span="8" :key="index" v-for="(tag, index) in editMarkTypeForm.datas">
                        <div class="flex_row align_center">
                            <el-tag style="height: 30px" class="flex_1" :color="tag.color" size="medium" effect="dark" closable :disable-transitions="false" @close="handleEditMarkTypeTagClose(tag, index)">
                                {{ getMaxString(tag.tag) }}-{{ getMaxString(tag.name) }}
                            </el-tag>
                            <el-color-picker size="medium" v-model="tag.color" show-alpha :predefine="predefineColors"></el-color-picker>
                        </div>
        ...
        <el-form :inline="true" >
            <el-form-item label="标签名:">
                <el-input style="width: 120px" v-model="inputEditMarkTypeValue" placeholder="B/E..."></el-input>
            </el-form-item>
            <el-form-item label="描述:">
                <el-input style="width: 120px" v-model="inputEditMarkTypeName" placeholder="开始/结束..."></el-input>
            </el-form-item>
            <el-form-item label="选择颜色:">
                <el-color-picker size="medium" v-model="color" show-alpha :predefine="predefineColors"></el-color-picker>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" size="small" @click="handleEditMarkTypeTag">新增</el-button>
            </el-form-item>
        </el-form>
...
export default {
  ...
  mounted() {
    console.log('EntitySetting nounted');
  ...
  methods: {
    ...
    handleNewMarkTypeTag() {
      if ( this.inputNewMarkTypeValue) {
        this.newMarkTypeForm.datas.push({
          tag:  this.inputNewMarkTypeValue,
          name: this.inputNewMarkTypeName,
          color: this.color,
        });
      }
      this.inputNewMarkTypeValue = '';
      this.inputNewMarkTypeName = '';
    },
    handleEditMarkTypeTag() {
      if (this.inputEditMarkTypeValue) {
        this.editMarkTypeForm.datas.push({
          tag: this.inputEditMarkTypeValue,
          name: this.inputEditMarkTypeName,
            color:this.color
        });
      }
      this.inputEditMarkTypeValue = '';
      this.inputEditMarkTypeName = '';
    },
